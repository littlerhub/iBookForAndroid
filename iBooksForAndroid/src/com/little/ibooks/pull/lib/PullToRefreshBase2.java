package com.little.ibooks.pull.lib;
...
import com.little.ibooks.pull.lib.internal.LoadingLayout2;
import com.little.ibooks.*;

public abstract class PullToRefreshBase2<T extends View> extends LinearLayout {
	...
	private LoadingLayout2 footerLayout;
	...
	public PullToRefreshBase2(Context context, int mode) {
		super(context);
		this.mode = mode;
		init(context, null);
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			headerLayout = new LoadingLayout2(context, MODE_PULL_DOWN_TO_REFRESH, releaseLabel, pullLabel,
					refreshingLabel);
		...
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			footerLayout = new LoadingLayout2(context, MODE_PULL_UP_TO_REFRESH, releaseLabel, pullLabel, refreshingLabel);
