...
import com.little.ibooks.pull.lib.internal.EmptyViewMethodAccessor;


public abstract class PullToRefreshAdapterViewBase2<T extends AbsListView> extends PullToRefreshBase2<T> implements
		OnScrollListener {
	...
	public PullToRefreshAdapterViewBase2(Context context, int mode) {
		super(context, mode);
		refreshableView.setOnScrollListener(this);
	}
