package com.little.ibooks.pull.lib.internal;
...
import com.little.ibooks.pull.lib.PullToRefreshBase2;
...
public class LoadingLayout2 extends FrameLayout {
	...
	public LoadingLayout2(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		super(context);
		...
		switch (mode) {
			case PullToRefreshBase2.MODE_PULL_UP_TO_REFRESH:
				headerImage.setImageResource(R.drawable.pulltorefresh_up_arrow);
				break;
			case PullToRefreshBase2.MODE_PULL_DOWN_TO_REFRESH:
			default:
