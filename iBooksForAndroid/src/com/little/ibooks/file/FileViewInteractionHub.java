...
import com.little.ibooks.file.FileListItem.ModeCallback;
import com.little.ibooks.file.FileOperationHelper.IOperationProgressListener;
import com.little.ibooks.file.FileSortHelper.SortMethod;
import com.little.ibooks.file.FileViewActivity.SelectFilesCallback;
import com.little.ibooks.file.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    protected void onNavigationBarClick() {
        if (mDropdownNavigation.getVisibility() == View.VISIBLE) {
            ...
            while (pos != -1) {
                ...
                View listItem = LayoutInflater.from(mContext).inflate(R.layout.file_dropdown_item,
                        null);
    ...
    private com.little.ibooks.file.FileViewInteractionHub.Mode mCurrentMode;
